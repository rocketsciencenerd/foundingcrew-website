  ...
  items: [
    {
      ...
      desc: 'We help you identify and scope value opportunities: new workflows, technologies, and AI use cases. We find where the value is, size it, and define the first build. Discovery ends in a scoped engagement, not a report.',
      deliverables: [
      ...
      who: "Leaders who know something needs to change but haven't scoped what.",
    },
    {
      num: '02',
      name: 'Digital Solutions',
      subtitle: '0→1 Product Development',
      desc: 'Digital products, platforms, internal tools, AI solutions, and connected hardware and software — built from concept to launch. Product direction, design, and engineering as one accountable team, inside your environment.',
      deliverables: [
        'Product strategy',
        'UX & product design',
